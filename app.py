...
def escolherCandidato():
    ...
    print("Digite: 1 - para Bolsonaro; 2 - para Ciro; 3 - para Davila; 4 - para Kelmon; 5 - para Lula; 6 - para Simone; 7 - para Soraya")
    ...
    if opcao == 1:
        ...
        conteudo = documentoIntegral('Plano_Simone.pdf')
        return conteudo
    elif opcao == 7:
...
candidatos=["Bolsonaro", "Ciro", "Daviala", "Kelmon", "Lula", "Simone", "Soraya"]
planos=[documentoIntegral('plano-de-governo-2023-2026-jair-bolsonaro.pdf'), documentoIntegral('ciro_360.pdf'), documentoIntegral('Plano-de-Governo-Felipe-Davila.pdf'), documentoIntegral('padreKelmon.pdf'), documentoIntegral('plano_gov_lula.pdf'), documentoIntegral('Plano_Simone.pdf'), documentoIntegral('Plano-de-governo-Soraya-Thronicke.pdf')]
